...
const projects = [
  {
    ...
    desc: 'A comprehensive project management and analytics dashboard built for a fintech startup managing 50+ client portfolios. Real-time data visualization, role-based access control, and multi-tenant architecture.',
...
export default function Portfolio() {
  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="portfolio-grid">
            {filtered.map(p => (
              <div key={p.id} className="glass-card portfolio-card fade-in-section" ref={addRef}>
                <div className="portfolio-img-wrap">
                  <img src={p.img} alt={p.title} />
                  <div className="portfolio-overlay">
                    <span className="tech-tag" style={{ background: 'rgba(108,61,255,0.8)', color: '#fff', border: 'none' }}>
                      {p.category}
                    </span>
                  </div>
                </div>
        ...
        <div className="container">
          ...
          <div className="tech-grid">
            {[
              ...
              <div key={t.name} className="tech-item fade-in-section" ref={addRef}>
      ...
      {/* CTA */}
      <section className="section-sm" style={{ textAlign: 'center', borderTop: '1px solid var(--glass-border)' }}>
        <div className="container">
